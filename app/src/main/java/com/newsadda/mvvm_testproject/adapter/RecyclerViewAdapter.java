package com.newsadda.mvvm_testproject.adapter;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerViewAdapter(Activity context, ArrayList<AdapterUser> userArrayList) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        AdapterUser user = userArrayList.get(position);
